...
<head>
	...
	<script type="text/javascript">
		function checkValue(){
			...
			var board_subject = form.board_subject.value; //제목을 입력
			var board_content = form.board_content.value; //내용을 입력
...
<body>
	...
	<input type="hidden" name="board_id" value="${sessionScope.sessionID}"><!-- 아이디도 같이 넘겨주기 위해서 -->
	<table width="700" border="3" bordercolor="lightgray" align="center">
		...
		<tr align="center" valign="middle">
			<td colspan="5">
				...
				<input type="button" value="목록" onclick="chage()" >			
			</td>
		</tr>
	</table>	
	</form>
